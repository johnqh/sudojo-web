...
const TopBar: React.FC<{
...
}> = ({ renderable, handleDrawerToggle, handleLoginOpen }) => {
    ...
    return (
        <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + 1 }} style={appBarStyle}>
            <Toolbar style={toolbarStyle}>
                ...
                <Typography variant="h6" noWrap sx={{ flexGrow: 1 }} style={typographyStyle}>
