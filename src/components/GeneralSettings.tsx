            ...
            <List>
                ...
                <ListItem>
                    <FormControl fullWidth>
                        <InputLabel id="select-option1-label">
                            Select Language
                        </InputLabel>
                        <Select
                            ...
                            onChange={(e) =>
                                setSelectedOption1(e.target.value as string)
                            }
                        >
                ...
                <ListItem>
                    <FormControl fullWidth>
                        <InputLabel id="select-option2-label">
                            Select Theme
                        </InputLabel>
                        <Select
                            ...
                            label="Select Theme"
                            onChange={(e) =>
                                setSelectedOption2(e.target.value as string)
                            }
                        >
